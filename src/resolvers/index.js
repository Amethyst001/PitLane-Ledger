...
function getMockParts() {
  ...
  return [
    // POWER UNIT
    { id: 'pu-1', key: 'PIT-101', name: 'Power Unit ICE #1', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 85, lastUpdated: new Date(now - 2 * day).toISOString() },
    { id: 'pu-2', key: 'PIT-102', name: 'Power Unit MGU-H #2', pitlaneStatus: '✈️ In Transit', location: 'DHL Cargo', assignment: 'Spares', life: 100, lastUpdated: new Date(now - 5 * day).toISOString() },
    { id: 'pu-3', key: 'PIT-103', name: 'Power Unit MGU-K #1', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 92, lastUpdated: new Date(now - 1 * day).toISOString() },
    { id: 'pu-4', key: 'PIT-104', name: 'Power Unit Turbocharger', pitlaneStatus: '⚠️ DAMAGED', location: 'Quarantine', assignment: 'Unassigned', life: 0, lastUpdated: new Date(now - 8 * day).toISOString() },

    // GEARBOX
    { id: 'gb-1', key: 'PIT-201', name: 'Gearbox Casing Titanium', pitlaneStatus: '🏁 Trackside', location: 'Garage 2', assignment: 'Car 2 (Sainz)', life: 78, lastUpdated: new Date(now - 3 * day).toISOString() },
    { id: 'gb-2', key: 'PIT-202', name: 'Gearbox Sequential Actuator', pitlaneStatus: '🏁 Trackside', location: 'Garage 2', assignment: 'Car 2 (Sainz)', life: 88, lastUpdated: new Date(now - 1 * day).toISOString() },

    // AERO - FRONT WING
    { id: 'fw-1', key: 'PIT-301', name: 'Front Wing Assembly FW47', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 60, lastUpdated: new Date(now - 2 * day).toISOString() },
    { id: 'fw-2', key: 'PIT-302', name: 'Front Wing Endplate Left', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 55, lastUpdated: new Date(now - 4 * day).toISOString() },
    { id: 'fw-3', key: 'PIT-303', name: 'Front Wing Flap Upper', pitlaneStatus: '🏭 Manufactured', location: 'Grove Factory', assignment: 'Spares', life: 100, lastUpdated: new Date(now - 6 * day).toISOString() },
    { id: 'fw-4', key: 'PIT-307', name: 'Front Wing Mainplane (High DF)', pitlaneStatus: '🏁 Trackside', location: 'Garage 2', assignment: 'Car 2 (Sainz)', life: 95, lastUpdated: new Date(now - 1 * day).toISOString() },

    // AERO - REAR WING
    { id: 'rw-1', key: 'PIT-304', name: 'Rear Wing DRS Mainplane', pitlaneStatus: '🏁 Trackside', location: 'Garage 2', assignment: 'Car 2 (Sainz)', life: 40, lastUpdated: new Date(now - 1 * day).toISOString() },
    { id: 'rw-2', key: 'PIT-305', name: 'Rear Wing DRS Actuator', pitlaneStatus: '✈️ In Transit', location: 'DHL Cargo', assignment: 'Spares', life: 100, lastUpdated: new Date(now - 7 * day).toISOString() },
    { id: 'rw-3', key: 'PIT-306', name: 'Beam Wing Carbon', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 70, lastUpdated: new Date(now - 2 * day).toISOString() },

    // FLOOR
    { id: 'fl-1', key: 'PIT-401', name: 'Floor Diffuser Carbon', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 50, lastUpdated: new Date(now - 3 * day).toISOString() },
    { id: 'fl-2', key: 'PIT-402', name: 'Floor Plank Wooden', pitlaneStatus: '🏁 Trackside', location: 'Garage 2', assignment: 'Car 2 (Sainz)', life: 20, lastUpdated: new Date(now - 10 * day).toISOString() },

    // SUSPENSION
    { id: 'sus-1', key: 'PIT-501', name: 'Front Wishbone Upper', pitlaneStatus: '🏁 Trackside', location: 'Garage 1', assignment: 'Car 1 (Albon)', life: 80, lastUpdated: new Date(now - 5 * day).toISOString() },
    { id: 'sus-2', key: 'PIT-502', name: 'Rear Pushrod Carbon', pitlaneStatus: '🛑 RETIRED', location: 'Scrap Bin', assignment: 'None', life: 0, lastUpdated: new Date(now - 12 * day).toISOString() }
  ];
}
...
export const handler = async (event, context) => {
  ...
  try {
    ...
    if (functionKey === 'rovoGetRaceCalendar' || functionKey === 'get-race-calendar') {
      return [
